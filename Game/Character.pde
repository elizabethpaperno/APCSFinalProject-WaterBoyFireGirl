  ...
  void check() {
    ...
    */
    ...
    for (int i = 0; i< d.size(); i++) {
      Door a = d.get(i);
      if ( (pos.x >= a.getPixelX() && pos.x + playerWidth <= a.getPixelX() +  a.getPixelWidth()) && (pos.y >= a.getPixelY()  && pos.y + playerHeight <= a.getPixelY() + a.getPixelHeight()) && a.getColor() == getColor()) {
        a.setOpen(true);
        changeC(true);
