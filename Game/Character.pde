public class Character { //<>// //<>// //<>// //<>//
  ...
  void check() {
    ...
    for (int i = 0; i<butt.size(); i++) {
      ...
      if (range(a.getPixelX(), a.getPixelX() + a.getPixelWidth(), a.getPixelY(), a.getPixelY() + a.getPixelHeight(), pos.x, pos.y +  playerHeight)|| range(a.getPixelX(), a.getPixelX() + a.getPixelWidth(), a.getPixelY()-3, a.getPixelY() + a.getPixelHeight(), other.pos.x, other.pos.y +  other.playerHeight)) {
        a.plat().move();
      }
      else { 
